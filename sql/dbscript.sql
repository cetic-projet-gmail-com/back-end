...
INSERT INTO colours (name , code ) VALUES ('Vert Foncé', '#53853d'), ('Vert CETIC', '#6fb052'), ('Vert clair', '#d7e6cc'), ('Gris Foncé', '#5a5a5a'), ('Gris Moyen', '#808080'), ('Gris clair', '#cccccc'), ('Rouge ECS', '#f62f00'), ('Jaune SSE', '#feb602'), ('Bleu SST', '#00b0f0'), ('Bleu foncé', '#0070c0'), ('Mauve', '#7030a0');
...
INSERT INTO tasks (activityId, ended, createdAt, updatedAt , name, description ) VALUES (1, 0, '2020-03-03',  '2020-03-04', 'tafwe test 2', 'ceci est wefwef petit test');
INSERT INTO tasks (activityId, ended, createdAt, updatedAt , name, description ) VALUES (1, 0, '2020-03-03',  '2020-03-04', 'tacwefwefwfest 2', 'ceci est un autre petit test');
INSERT INTO tasks (activityId, ended, createdAt, updatedAt , name, description ) VALUES (1, 0, '2020-03-03',  '2020-03-04', 'tacwefst 2', 'ceci est un auwefwefit test');
...
INSERT INTO activitiesAssignments (activityId , userId, createdAt , updatedAt ) VALUES (2, 3, '2020-03-02', '2020-03-02');
